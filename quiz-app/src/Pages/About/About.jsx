...
export default function About() {
  ...
  return (
    <>
     <div className='text-white bg-[#0492C2] text-left font-semibold h-[550px] md:w-1/3 lg:w-1/4 m-auto my-16 py-16 px-6 rounded-md'>
        ...
        or an intranet (a private network).[1] Web development can range from developing a simple
         ...
         <button onClick={()=>{
            navigate('/startpage')
         }} className='flex gap-4 items-center bg-white text-[#0492C2] px-2 py-1 rounded-md font-bold ms-auto mt-16'> 
<p>Next</p>
